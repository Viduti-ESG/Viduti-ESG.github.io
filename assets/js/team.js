...
(function () {
  ...
  async function api(method, path, body) {
    ...
    if (res.status === 401) { localStorage.removeItem('gc_auth_token'); localStorage.removeItem('gc_auth_user'); location.href = '/login?next=/team'; throw new Error('Not authenticated'); }
