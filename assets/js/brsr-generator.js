...
const API_BASE = "https://48ad97cb6878a45f-103-197-75-180.serveousercontent.com";
// const API_BASE = "https://48ad97cb6878a45f-103-197-75-180.serveousercontent.com";  // uncomment for local dev
...
function renderReport(report) {
  ...
  document.getElementById("reportSubtitle").textContent =
    `FY ${report.financial_year || ""} · ${report.reporting_boundary || ""} · Generated by Green Curve AI`;
  ...
  html += `<div style="padding:16px;background:#f8fafc;border-radius:8px;margin-top:24px;font-size:.75rem;color:#94a3b8">
    Generated by Green Curve AI · ${meta.generated_at || ""} ·
    Model: ${meta.model || ""} ·
