...
# ── Per-company HTML ───────────────────────────────────────────────────────────
# Canonical site nav (kept in sync with index.html / tools/propagate_mobile_nav.py).
# Root-absolute clean URLs so the same block works at any directory depth, and a
# self-contained burger toggle because generated pages load no other JS.
NAV = """
<header class="site-header" id="site-header">
  <nav class="nav container">
    ...
    <ul class="nav__links" role="list">
      ...
      <li class="nav__has-dropdown">
        <a class="nav__dropdown-toggle" href="/esg-intelligence" style="color:var(--emerald)">ESG Quotient <span class="nav__caret"></span></a>
        <ul class="nav__dropdown">
...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/style.css?v=20260807a"/>
